...
configFluidvtm = XMLMultiBlockDataReader(FileName=['configFluid.vtm'])

# create a new 'Pass Arrays'
passArrays1 = PassArrays(Input=configFluidvtm)
#passArrays1.PointDataArrays = ['Eddy_Viscosity', 'Pressure', 'Temperature', 'Velocity']
passArrays1.PointDataArrays = ['Eddy_Viscosity', 'Pressure', 'Temperature', 'Velocity', 'Recovered_Pressure', 'Recovered_Temperature']
